...
def marine_hourly():
	...
	return {
		"hourly": {
			"time": times,
			"wave_height": [1.2, 1.5, 1.0, 0.8, 1.0, 0.5],
			"wave_period": [8.0, 9.0, 7.5, 6.0, 7.0, 5.0],
			"wave_direction": [280.0, 290.0, 270.0, 260.0, 275.0, 250.0],
		},
	}
...
def weather_hourly():
	...
	return {
		"hourly": {
			"time": times,
			"wind_speed_10m": [12.0, 15.0, 10.0, 8.0, 9.0, 7.0],
			"wind_direction_10m": [180.0, 200.0, 160.0, 170.0, 190.0, 155.0],
		},
	}
